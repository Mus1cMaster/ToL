...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu2 cid-tEwkr41EGu" once="menu" id="menu2-8">
...
<section data-bs-version="5.1" class="header18 cid-tEwCL1HlD7 mbr-fullscreen" id="header18-c">
    ...
    <div class="align-center container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-12">
                ...
                <p class="mbr-text mbr-fonts-style mbr-white display-7">We're a platform where you can access and download a wide range of programming projects in C#, HTML, and PHP. Additionally, we offer the opportunity to explore and download exploits for games like Roblox, Windows activators, and generic bypasses all created by our team. You can also contribute by sharing your own projects and files <a href="https://discord.gg/ZtrrGxpqtk" class="text-black" target="_blank">here</a>. Join us and expand your coding skills while engaging in a supportive and collaborative environment.</p>
                <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="page1.php">Go to Projects</a> <a class="btn btn-black display-4" href="page1.php">Go to Drive</a></div>
            </div>
        </div>
    </div>  
